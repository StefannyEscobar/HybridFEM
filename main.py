...
# Example usage
input_parameters = np.array([4.0, 100.0])  # Replace with your actual input values
...
# Create new Function objects for d_result and e_result
d_result_function = Function(M)
e_result_function = Function(M)

# Assign values to the new Function objects
d_result_function.vector()[:] = d_result
e_result_function.vector()[:] = e_result

# Guardar los resultados
File("inverse_results/predicted_d.pvd") << d_result_function
File("inverse_results/predicted_e.pvd") << e_result_function
